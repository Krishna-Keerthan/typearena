    ...
    <div className="bg-gray-800 rounded-lg p-6 space-y-4">
      ...
      <div className="space-y-4">
        <input
          ...
          className="w-full bg-gray-700 text-white px-4 py-3 rounded-md border border-gray-600 focus:border-green-400 focus:outline-none"
        ...
        <div className="grid grid-cols-2 gap-4">
          <select
            ...
            className="bg-gray-700 text-white px-4 py-3 rounded-md border border-gray-600 focus:border-green-400 focus:outline-none appearance-none cursor-pointer"
          >
